...
const Footer = () => {
  return (
    <footer className="site-footer" itemType="https://schema.org/WPFooter" itemScope>
      <div className="site-footer__contact">
        ...
        <div className="site-footer__left">
          ...
          <div className="site-footer__social">
            {/* WAC-TODO: WR placeholder links/copy copied for parity.
                Replace with Wellington Adventure Centre profiles + fine print. */}
            <a
      ...
      {/* WAC-TODO: confirm each certification badge applies to WAC, or replace. */}
      ...
      <div className="site-footer__fine-print">
        ...
        <div>
          {/* WAC-TODO: WR placeholder copy copied for parity. Replace with the
              Wellington Adventure Centre fine print. */}
          <p>
